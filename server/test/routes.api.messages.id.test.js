    ...
    it('should not show capcode in hidecapcode mode if not logged in ', (done) => {
        ...
        chai.request(server)
            ...
            .end((err, res) => {
                ...
                res.body.should.have.property('message').eql('This is a Test Message to Address 1234569');
        ...
        chai.request(server)
            ...
            .end((err, res) => {
                ...
                res.body.should.have
                    .property('message')
                    .eql('This is a Test Message to Address 1234571, that should be hidden to unauthorized users');
